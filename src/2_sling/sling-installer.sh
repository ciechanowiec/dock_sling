...
downloadArtifacts() {
  echo "Downloading Sling artifacts..."
  curl --output "$SLING_DIR/sling-12.far" https://repo1.maven.org/maven2/org/apache/sling/org.apache.sling.starter/12/org.apache.sling.starter-12-oak_tar_far.far
  echo "Downloaded Sling 12 to: $SLING_DIR"
